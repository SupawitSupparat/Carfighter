...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player1_wall = arcade.Sprite("images/block.png", SPRITE_SCALING)
        self.player1_wall.center_x = 50
        self.player1_wall.center_y = 50

        self.player1_sprite = Player("images/motorbike-play1.png", SPRITE_SCALING)
        self.player1_sprite.center_x = 50
        self.player1_sprite.center_y = 50

        self.player1_list.append(self.player1_sprite)
        self.player1_list.append(self.player1_wall)



        self.player2_sprite = Player("images/motorbike-play2.png", SPRITE_SCALING)
